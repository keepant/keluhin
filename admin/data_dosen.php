...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <!--- MODAL Detail -->
        <div class="modal fade" id="detailDosen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">Detail data dosen</h4>
        ...
        <div class="modal fade" id="editDosen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">Edit data dosen</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                                ...
                                <div class="table-stats order-table ov-h">
                                    <table class="table ">
                                        ...
                                        <?php
                                            ...
                                            $no=0;
                                            $query = mysqli_query($con, "select *from dosen order by nama_dosen asc");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-info btn-sm" data-whatever="<?php echo $row['id']?>"
                                                        data-toggle="modal" data-target="#detailDosen">
                                                        <i class="fas fa-info-circle"></i>
                                                    </button>
                                                    <button class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                                        data-whatever="<?php echo $row['id']?>" data-target="#editDosen">
