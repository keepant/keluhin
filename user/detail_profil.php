...
<?php
    ...
    if(isset($_POST['simpan'])) {
        ...
        mysqli_query($con, "update mahasiswa set nama='$nama', kelas='$kelas', angkatan='$angkatan' where email='$id'");
        header('location: /user/index.php');
}
    $members = mysqli_query($con, "select *from mahasiswa where email='$id'");
    ...
    <form action="detail_profil.php" method="post">
        <div class="modal-body mx-5">
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="text" readonly class="form-control" value="<?php echo $mem['nim'];?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="kelas" value="<?php echo $mem['kelas'];?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"><strong>Angkatan</strong></label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="angkatan" value="<?php echo $mem['angkatan'];?>">
                </div>
            </div>
            <div class="form-group row">
